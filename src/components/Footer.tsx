...
export default function Footer() {
  ...
  const links = [
    { href: "/products", key: "linkProducts" as const },
    { href: "/quality", key: "linkQuality" as const },
    { href: "/about", key: "linkAbout" as const },
    { href: "/contact", key: "linkContact" as const },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="font-oswald text-xl font-bold text-white mb-4">JBJT Global</h3>
